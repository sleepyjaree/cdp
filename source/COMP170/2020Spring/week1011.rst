...
The code below implements the Building class. (`The code is also available from Github <https://github.com/lgreco/cdp/blob/master/source/COMP170/codeExamples/Elevator/src/Building.java>`__). The comments in the code  complement the earlier analysis about the Building class. 
